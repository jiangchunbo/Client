    ...
    <el-container style="border: 1px solid #eee">
        ...
        <el-main>
            ...
            <el-table
                ...
                <el-table-column property="rainfall" label="降雨量"></el-table-column>
    ...
    export default {
        ...
        data: () => {
            return {
                tableData: [
                    {
                        date: '2015-1', rainfall: '2.6'
                    },
                    {
                        date: '2015-2', rainfall: '5.9'
                    },
                    {
                        date: '2015-3',
                        rainfall: '9.0'
                    ...
                    {
                        date: '2016-1', rainfall: '3.9'
                    },
                    {
                        date: '2016-2', rainfall: '5.9'
                    },
                    {
                        date: '2016-3',
                        rainfall: '11.1'
